...
class TlsCertificateHostnameTest {
    ...
    void cleanupSystemProperties() {
        System.clearProperty("floci-oci.hostname");
        System.clearProperty("floci-oci.base-url");
        System.clearProperty("floci-oci.tls.enabled");
        System.clearProperty("floci-oci.tls.self-signed");
        System.clearProperty("floci-oci.tls.cert-path");
        System.clearProperty("floci-oci.tls.key-path");
        System.clearProperty("floci-oci.storage.persistent-path");
    }
    ...
    void testFlociHostnameIncludedInCertificateSans() throws Exception {
        // Arrange
        System.setProperty("floci-oci.hostname", "floci");
        System.setProperty("floci-oci.tls.enabled", "true");
        System.setProperty("floci-oci.tls.self-signed", "true");
        System.setProperty("floci-oci.storage.persistent-path", tempDir.toString());
    ...
    void testBaseUrlHostnameIncludedInCertificateSans() throws Exception {
        // Arrange
        System.setProperty("floci-oci.base-url", "https://myhost:4566");
        System.setProperty("floci-oci.tls.enabled", "true");
        System.setProperty("floci-oci.tls.self-signed", "true");
        System.setProperty("floci-oci.storage.persistent-path", tempDir.toString());
    ...
    void testBaseUrlIpAddressIncludedInCertificateSans() throws Exception {
        // Arrange
        System.setProperty("floci-oci.base-url", "https://192.168.1.100:4566");
        System.setProperty("floci-oci.tls.enabled", "true");
        System.setProperty("floci-oci.tls.self-signed", "true");
        System.setProperty("floci-oci.storage.persistent-path", tempDir.toString());
    ...
    void testBothHostnamesIncludedInCertificateSans() throws Exception {
        // Arrange
        System.setProperty("floci-oci.hostname", "newhost");
        System.setProperty("floci-oci.base-url", "http://oldhost:4566");
        System.setProperty("floci-oci.tls.enabled", "true");
        System.setProperty("floci-oci.tls.self-signed", "true");
        System.setProperty("floci-oci.storage.persistent-path", tempDir.toString());
    ...
    void testConfigurationChangeTriggersRegeneration() throws Exception {
        ...
        System.setProperty("floci-oci.hostname", "host1");
        System.setProperty("floci-oci.tls.enabled", "true");
        System.setProperty("floci-oci.tls.self-signed", "true");
        System.setProperty("floci-oci.storage.persistent-path", tempDir.toString());
        ...
        System.setProperty("floci-oci.hostname", "host2");
        new TlsConfigSource();
    ...
    void testUserProvidedCertificatesUsedWithoutModification() throws Exception {
        ...
        System.setProperty("floci-oci.tls.enabled", "true");
        System.setProperty("floci-oci.tls.cert-path", userCertFile.toString());
        System.setProperty("floci-oci.tls.key-path", userKeyFile.toString());
        System.setProperty("floci-oci.storage.persistent-path", tempDir.toString());
    ...
    void testTlsDisabledSkipsCertificateGeneration() throws Exception {
        // Arrange
        System.setProperty("floci-oci.tls.enabled", "false");
        System.setProperty("floci-oci.storage.persistent-path", tempDir.toString());
    ...
    static Stream<Map<String, String>> defaultConfigurations() {
        return Stream.of(
            Map.of("floci-oci.tls.enabled", "true", "floci-oci.tls.self-signed", "true"),
            Map.of("floci-oci.tls.enabled", "true", "floci-oci.tls.self-signed", "true", 
                   "floci-oci.base-url", "http://localhost:4566"),
            Map.of("floci-oci.tls.enabled", "true", "floci-oci.tls.self-signed", "true", 
                   "floci-oci.base-url", "http://127.0.0.1:4566"),
            Map.of("floci-oci.tls.enabled", "true", "floci-oci.tls.self-signed", "true", 
                   "floci-oci.hostname", "localhost"),
            Map.of("floci-oci.tls.enabled", "true", "floci-oci.tls.self-signed", "true", 
                   "floci-oci.base-url", "https://localhost:4566"),
            Map.of("floci-oci.tls.enabled", "true", "floci-oci.tls.self-signed", "true", 
                   "floci-oci.base-url", "http://0.0.0.0:4566")
        );
    }
}
