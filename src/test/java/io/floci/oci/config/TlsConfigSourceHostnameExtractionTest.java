...
class TlsConfigSourceHostnameExtractionTest {
    ...
    void testFilterDefaultLocalhostFromHostname() throws Exception {
        // Arrange
        System.setProperty("floci-oci.hostname", "localhost");
    ...
    void testFilterDefaultLoopbackIp() throws Exception {
        // Arrange
        System.setProperty("floci-oci.base-url", "http://127.0.0.1:4566");
    ...
    void testFilterDefaultAllInterfacesIp() throws Exception {
        // Arrange
        System.setProperty("floci-oci.base-url", "http://0.0.0.0:4566");
    ...
    void testDeduplication() throws Exception {
        // Arrange
        System.setProperty("floci-oci.hostname", "myhost");
        System.setProperty("floci-oci.base-url", "http://myhost:4566");
    ...
    void testMalformedUrl() throws Exception {
        // Arrange
        System.setProperty("floci-oci.base-url", "not-a-valid-url");
    ...
    void testUrlWithoutHost() throws Exception {
        // Arrange
        System.setProperty("floci-oci.base-url", "file:///path/to/file");
    ...
    void testBlankHostname() throws Exception {
        // Arrange
        System.setProperty("floci-oci.hostname", "   ");
    ...
    void testIpv6Address() throws Exception {
        // Arrange
        System.setProperty("floci-oci.base-url", "http://[::1]:4566");
